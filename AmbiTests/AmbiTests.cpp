...
int main()
{
	...
	// The jobs that need doing will be added to a global job queue. Max number is based on number of threads since for this test, we will only be processing one job per thread
